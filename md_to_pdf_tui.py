...
def process_resources(md_text: str, temp_dir: Path) -> str:
    ...
    # Optimization: Use set comprehension with union for faster C-level iteration
...
async def generate_docx_core(md_path: Path, docx_path: Path, log_fn=print, prog_fn=None, settings: dict=None) -> None:
    ...
    # --- PROCESS ALERTS ---
    # ⚡ Bolt: Fast-path optimization. Skip expensive line splitting and iteration if no alerts exist.
