...
def create_html_content(md_text: str, settings: dict) -> str:
    ...
    has_mermaid = bool(MERMAID_PATTERN.search(md_text))
    mermaid_injection = ""

    if m_enabled and has_mermaid:
        ...
        mermaid_injection = f'''<script src="https://cdn.jsdelivr.net/npm/mermaid@11.4.1/dist/mermaid.min.js"></script>
<script>
mermaid.initialize({{ 
    startOnLoad: true, 
    {m_theme_init},
