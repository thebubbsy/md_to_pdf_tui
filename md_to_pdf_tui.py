...
def _process_alerts(md_text: str, alert_styles: dict, text_color: str) -> str:
    ...
    for line in lines:
        ...
        if match:
            ...
            if in_alert:
                ...
                html_table = f'<table style="width:100%; border-left: 5px solid {style["color"]}; background-color: {style["bg"]}; margin-bottom: 10px;"><tr><td style="padding: 10px; color: {text_color};"><strong>{style["icon"]} {alert_type.upper()} - </strong><br/>{c_html}</td></tr></table>'
