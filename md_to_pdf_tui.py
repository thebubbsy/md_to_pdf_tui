...
"""
            ...
            with TabbedContent():
                ...
                with TabPane("Paste & Preview"):
                    ...
                    with Horizontal(id="preview-controls"):
                         ...
                         yield Button("🌐 Browser Preview", id="browser-preview-btn", variant="default", tooltip="Open a live HTML preview in your default browser")
                         if HAS_PIXELS:
                             yield Button("🖼️ Render Graphs", id="tui-render-btn", variant="default", tooltip="Render and display Mermaid diagrams in the TUI")
        ...
        def action_render_tui(self):
            ...
            if self.use_paste_source:
                ...
                toggle_btn.tooltip = "Return to the Markdown editor"
