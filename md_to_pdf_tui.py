...
"""
            ...
            with TabbedContent():
                ...
                with TabPane("Paste & Preview"):
                    ...
                    with Horizontal(id="preview-controls"):
                         yield Button("👁️ TUI Preview", id="toggle-view-btn", disabled=True, variant="primary", tooltip="Switch to TUI preview mode")
                         yield Button("🌐 Browser Preview", id="browser-preview-btn", variant="default", tooltip="Open markdown in default web browser")
                         if HAS_PIXELS:
                             yield Button("🖼️ Render Graphs", id="tui-render-btn", variant="default", tooltip="Render Mermaid diagrams in TUI")
        ...
        def on_switch_changed(self, event: Switch.Changed):
            if event.switch.id == "a4-width-switch": self.settings["a4_fixed_width"] = event.value
                ...
                if event.value:
                    ...
                    toggle_btn.tooltip = "Switch to TUI preview mode"
        ...
        async def on_button_pressed(self, event: Button.Pressed):
            ...
            if event.button.id == "convert-btn": self.action_convert()
                ...
                if switcher.current == "paste-area":
                    ...
                    btn.tooltip = "Switch to TUI preview mode"
                    btn.variant = "primary"
        ...
        def action_render_tui(self):
            ...
            if self.use_paste_source:
                ...
                self.query_one("#toggle-view-btn", Button).tooltip = "Switch back to markdown editor"
