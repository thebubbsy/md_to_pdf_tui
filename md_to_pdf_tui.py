            ...
            with TabbedContent():
                ...
                with TabPane("Paste & Preview"):
                    ...
                    with Horizontal(id="preview-controls"):
                         yield Button("👁️ TUI Preview", id="toggle-view-btn", disabled=True, variant="primary", tooltip="Toggle between raw text editor and parsed markdown preview")
                         yield Button("🌐 Browser Preview", id="browser-preview-btn", variant="default", tooltip="Open a temporary browser window to view the generated HTML with rendered CSS/Mermaid")
                         if HAS_PIXELS:
                             yield Button("🖼️ Render Graphs", id="tui-render-btn", variant="default", tooltip="Parse and render Mermaid diagrams directly in the TUI (requires Playwright and RichPixels)")
