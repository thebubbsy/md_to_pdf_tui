...
"""
            ...
            with TabbedContent():
                ...
                with TabPane("Paste & Preview"):
                    ...
                    with Horizontal(id="preview-controls"):
                         ...
                         yield Button("🌐 Browser Preview", id="browser-preview-btn", variant="default", tooltip="Preview the parsed markdown in a browser window")
                         if HAS_PIXELS:
                             yield Button("🖼️ Render Graphs", id="tui-render-btn", variant="default", tooltip="Render Mermaid diagrams inline in the terminal")
        ...
        def action_render_tui(self):
            ...
            if self.use_paste_source:
                ...
                self.query_one("#toggle-view-btn", Button).tooltip = "Switch to text editor"
