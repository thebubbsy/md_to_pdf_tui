...
def create_html_content(md_text: str, settings: dict) -> str:
    ...
    mermaid_scripts = ""
    # ⚡ Bolt: Conditionally inject Mermaid.js only if diagrams are present in the HTML
    # This avoids a significant overhead when generating PDFs/PNGs for standard text-only documents.
