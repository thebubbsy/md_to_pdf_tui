...
if HAS_TEXTUAL:
    class HelpScreen(ModalScreen):
        ...
        def compose(self) -> ComposeResult:
            yield Container(Static("[b]⌨️ Keyboard Shortcuts[/b]\n", id="help-title"), Static("[cyan]Ctrl+O[/] Browse\n[cyan]Ctrl+R[/] Convert PDF\n[cyan]Ctrl+D[/] Convert DOCX\n[cyan]Ctrl+P[/] Open PDF\n[cyan]F1[/] Help"), Rule(), Button("Close", id="dismiss-btn", variant="primary"), id="help-dialog")
            yield Footer()
        ...
        CSS = """
        #help-dialog { width: 50; padding: 2; background: #1a1a1a; border: round #555; }
        #help-title { content-align: center middle; }
